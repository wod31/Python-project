...
def impose_clash(str1, strs, k, i, num_contact, c, similar_chains):
    ...
    if i >= k:
        ...
        str5 = str1.copy()
        for model in models:
            superimposed_models = Superimpose(model, str5)
        ...
        if not repeated:
            ...
            io.save("selected_pdbs3/dimer_prova" + str(id(str1)) + ".pdb")
            models.append(str1)
            return
        else:
            return
            ...
            for chain2 in chains2:
                ...
                if similar_chains[chain1.id] == similar_chains[chain2.id]:
                    ...
                    if len(clashes) >= num_contact:
                        ...
                        #io.save("selected_pdbs3/dimer"+ str(id(str3)) + ".pdb")
                        impose_clash(str3, strs, 3, i+1, 10, c, similar_chains)
...
print(strs)
impose_clash(strs[0], strs, 3, 0, 10, 0, similar_chains)
